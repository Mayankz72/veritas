...
/**
 * Surfaces sections with thin or weak evidence (Phase 5's "health panel").
 * "Strengthen" re-runs generation for that section with a wider retrieval
 * net (more chunks, more claims) rather than just re-asking the same way.
 */
