  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3 w-full max-w-md">
      ...
      <p className="text-xs text-black/40 dark:text-white/40">
        Ingestion fetches the PDF, extracts page-accurate sections, and
        embeds every chunk into pgvector - first run downloads the
        embedding model, so it can take ~15s.
      </p>
    </form>
  );
}
